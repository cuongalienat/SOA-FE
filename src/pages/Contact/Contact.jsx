    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto">
          Chúng tôi rất muốn nghe từ bạn. Đội ngũ thân thiện của chúng tôi luôn
          sẵn sàng trò chuyện.
        </p>
      </div>
        ...
        <div className="space-y-8">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Đội ngũ thân thiện của chúng tôi luôn sẵn sàng giúp đỡ.
              </p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Hãy đến chào chúng tôi tại trụ sở chính.
              </p>
              <p className="text-orange-600 font-semibold mt-1">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500">
                Thứ Hai - Thứ Sáu từ 8h sáng đến 5h chiều.
              </p>
              <p className="text-orange-600 font-semibold mt-1">
                +1 (555) 000-0000
              </p>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-gray-900 text-white py-3 rounded-xl font-bold hover:bg-orange-600 transition flex items-center justify-center"
              >
